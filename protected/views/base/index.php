...
<?= $r?>
         ...
         <?=CHtml::link('Все кандидаты(Mysql) ('.$votes[cand_all].')', array('candidats/index'), array('class'=>'more'))?>
         <?=CHtml::link('Все кандидаты (Mongo)('.$votes[cand_all].')', array('mongo/index'), array('class'=>'more'))?>   
		 <?=CHtml::link('Все кандидаты(CListviev) ('.$votes[cand_all].')', array('candidats/all'), array('class'=>'more'))?>
